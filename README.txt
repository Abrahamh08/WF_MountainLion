...
\
Note: If running files doesn't launch application, open the .command files in textedit and change the paths.}This is a (hopefully temporary) fix to allow  WiiFlashServerJ to run on
OS X 10.8 \"Mountain Lion\". *You do not need this* if you use an
earlier version of OS X.
